...
namespace ElectronicQueue.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20220613113609_RemovSpecialTicket")]
    partial class RemovSpecialTicket
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ElectronicQueue.Core.Domain.AccountDomain", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ElectronicQueue.Core.Domain.WorkerDomain", b =>
                {
                    b.HasOne("ElectronicQueue.Core.Domain.AccountDomain", "Account")
                        .WithOne("Worker")
                        .HasForeignKey("ElectronicQueue.Core.Domain.WorkerDomain", "AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
